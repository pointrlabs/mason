...
elseif(MASON_PLATFORM STREQUAL "android")
    if (ANDROID_ABI STREQUAL "armeabi")
        set(MASON_PLATFORM_VERSION "arm-v5-14")
    elseif(ANDROID_ABI STREQUAL "arm64-v8a")
        set(MASON_PLATFORM_VERSION "arm-v8-21")
    elseif(ANDROID_ABI STREQUAL "x86")
        set(MASON_PLATFORM_VERSION "x86-14")
    elseif(ANDROID_ABI STREQUAL "x86_64")
        set(MASON_PLATFORM_VERSION "x86-64-21")
    elseif(ANDROID_ABI STREQUAL "mips")
        set(MASON_PLATFORM_VERSION "mips-14")
    elseif(ANDROID_ABI STREQUAL "mips64")
        set(MASON_PLATFORM_VERSION "mips-64-21")
    else()
        set(MASON_PLATFORM_VERSION "arm-v7-14")
    endif()
    ...
    if(MASON_PACKAGE_${_PACKAGE}_INVOCATION STREQUAL "${MASON_INVOCATION}")
        ...
        foreach(_LINE IN LISTS _CONFIG_FILE)
            ...
            if (_KEY)
                ...
                if (_KEY STREQUAL "LDFLAGS" OR _KEY STREQUAL "STATIC_LIBS")
                    if (IS_DIRECTORY "${_INSTALL_PATH}/c++${CMAKE_CXX_STANDARD}")
                        string(REPLACE "{prefix}" "${_INSTALL_PATH}/c++${CMAKE_CXX_STANDARD}" _VALUE "${_VALUE}")
                    else()
